...
class Logger {
  ...
  success(message, data) { this._log({ level: 'success', message, data }) }
  warn(message, data) { this._log({ level: 'warn', message, data }) }
  error(message, data) { this._log({ level: 'error', message, data }) }
  debug(message, data) { this._log({ level: 'debug', message, data }) }
  peer(message, data) { this._log({ level: 'peer', message, data }) }
  connection(message, data) { this._log({ level: 'connection', message, data }) }
